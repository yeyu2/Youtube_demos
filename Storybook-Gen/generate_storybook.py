...
def generate_storybook(req: StoryRequest):
    ...
    try:
        ...
        # Generate images with reference for character consistency
        show_progress_message("Story created! Now generating images with character consistency...")
        ...
        image_usages = generate_storybook_images(
            ...
            delay_seconds=3,
            use_reference=True  # Always use reference for consistency
        )
        
        # Load the completed story with images
        show_progress_message("Images generated! Now creating the final PDF storybook...")
        story_with_images_path = output_dir / "story_with_images.json"
        with open(story_with_images_path, "r") as f:
...
def main():
    ...
    try:
        ...
        print("\nOutput files:")
        print(f"- PDF storybook: {result['pdf_path']}")
